    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Sistema Administrativo</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p style="text-center">
                      Administrador<br>{{$email = Auth::user()->email}}
                    </p>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2017-2020 <a href="www.maldondonet.com">Capacitaciones Maldonado</a>.</strong> All rights reserved.
      </footer>
